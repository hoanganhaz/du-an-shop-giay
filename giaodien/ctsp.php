  ...
  <main>
    ...
    <div class="boxcenter">
      <div class="zek_page_banner zek_position">
        <div class="zek_background wow fadeIn animated animated" data-wow-delay="500ms" data-wow-duration="600ms"
        ...
        <div class="inner text-center wow fadeIn animated animated" data-wow-delay="500ms" data-wow-duration="600ms"
          ...
          <div class="zek_breadcrumbs wow fadeInUp animated animated" data-wow-delay="700ms" data-wow-duration="600ms"
            ...
            <main class="col-lg-6">
              <div class="ps-lg-3">
                ...
                <p>
                  ...
                  from
                  the conventions of mainstream fashion. Made in Italy, these black and brown clothing low-top shirts
                  for
                  men.
                </p>
            ...
            <div class="customer-reviews">
              <h6 class="fw-bold mb-3">
                <font style="vertical-align: inherit;">
                  <font style="vertical-align: inherit;">Đánh giá của khách hàng (875)</font>
                </font>
              </h6>
              <div class="reviews-wrapper">
                <div class="d-flex flex-column flex-lg-row gap-3">
                  <div class=""><span class="badge bg-green rounded-0">
                      ...
                      </font><i class="bi bi-star-fill ms-1"></i>
                    </span></div>
                  <div class="flex-grow-1">
                    <p class="mb-2">
                      <font style="vertical-align: inherit;">
                        <font style="vertical-align: inherit;">Đây là một số nội dung từ một thành phần truyền thông.
                        </font>
                        <font style="vertical-align: inherit;">Bạn có thể thay thế nội dung này bằng bất kỳ nội dung nào
                          và điều chỉnh nó nếu cần. </font>
                        <font style="vertical-align: inherit;">Một số văn bản ví dụ nhanh để xây dựng và thực hiện trên
                          tiêu đề thẻ.</font>
                      </font>
                    </p>
                    ...
                    <div class="d-flex flex-column flex-sm-row gap-3 mt-3">
                      <div class="hstack flex-grow-1 gap-3">
                        <p class="mb-0">
                          <font style="vertical-align: inherit;">
                            <font style="vertical-align: inherit;">Jhon Deo</font>
                          </font>
                        </p>
                        <div class="vr"></div>
                        <div class="date-posted">
                          <font style="vertical-align: inherit;">
                            <font style="vertical-align: inherit;">ngày 12 tháng 6 năm 2020</font>
                          </font>
                        </div>
                      </div>
                      <div class="hstack">
                        <div class=""><i class="bi bi-hand-thumbs-up me-2"></i>
                          <font style="vertical-align: inherit;">
                            <font style="vertical-align: inherit;">68</font>
                          </font>
                        </div>
                        <div class="mx-3"></div>
                        <div class=""><i class="bi bi-hand-thumbs-down me-2"></i>
                          <font style="vertical-align: inherit;">
                  ...
                  <div class="flex-grow-1">
                    <p class="mb-2">
                      <font style="vertical-align: inherit;">
                        ...
                        <font style="vertical-align: inherit;">Bạn có thể thay thế điều này bằng bất kỳ nội dung nào.
                        </font>
                      </font>
                    </p>
                    <div class="review-img">
                    ...
                    <div class="d-flex flex-column flex-sm-row gap-3 mt-3">
                      <div class="hstack flex-grow-1 gap-3">
                        ...
                        <div class="date-posted">
                          <font style="vertical-align: inherit;">
                            <font style="vertical-align: inherit;">Ngày 15 tháng 6 năm 2020</font>
                          </font>
                        </div>
                      </div>
                      <div class="hstack">
                ...
                <hr>
                <div class="d-flex flex-column flex-lg-row gap-3">
                  <div class=""><span class="badge bg-warning rounded-0 text-dark">
                      <font style="vertical-align: inherit;">
                  ...
                  <div class="flex-grow-1">
                    ...
                    <div class="d-flex flex-column flex-sm-row gap-3 mt-3">
                      <div class="hstack flex-grow-1 gap-3">
                        ...
                        <div class="date-posted">
                          <font style="vertical-align: inherit;">
                            <font style="vertical-align: inherit;">22 tháng 6 năm 2022</font>
                          </font>
                        </div>
                      </div>
                      <div class="hstack">
                        <div class=""><i class="bi bi-hand-thumbs-up me-2"></i>
                          <font style="vertical-align: inherit;">
                            <font style="vertical-align: inherit;">98</font>
                          </font>
                        </div>
                        <div class="mx-3"></div>
                        <div class=""><i class="bi bi-hand-thumbs-down me-2"></i>
                ...
                <hr>
                <div class="d-flex flex-column flex-lg-row gap-3">
                  <div class=""><span class="badge bg-danger rounded-0">
                      <font style="vertical-align: inherit;">
                ...
                <div class="text-center">
                  <a href="javascript:;" class="btn btn-ecomm btn-outline-dark">
                    <font style="vertical-align: inherit;">
                      <font style="vertical-align: inherit;">Xem tất cả các đánh giá</font>
                    </font><i class="bi bi-arrow-right ms-2"></i>
                  </a>
                </div>
              </div>
            </div>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="d-flex mb-3">
                    <a href="#" class="me-3">
                      <img src="../duan1/img/adidas.jpg" style="min-width: 96px; height: 96px;"
                    ...
                    <div class="info">
                      ...
                      <strong class="text-dark mx-3"> $38.90</strong>
                    </div>
                  </div>
