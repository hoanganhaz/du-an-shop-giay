        ...
        <div class="boxcenter">
            <div class="zek_page_banner zek_position">
                <div class="zek_background wow fadeIn animated animated" data-wow-delay="500ms"
                    ...
                    style="background-image: url(./img\ menu/converse.png); visibility: visible; animation-duration: 600ms; animation-delay: 500ms; animation-name: fadeIn;">
                </div>
                ...
                <div class="item_home">
                    <div class="row">
                        <div class="col-md-3 box-item">
                            ...
                            <div class="text_item">
                                <p class="loai_hang">OXFORD</p>
                                <p class="gioi_thieu">SAVILLE CAPTOE OXFORD - OF32</p>
